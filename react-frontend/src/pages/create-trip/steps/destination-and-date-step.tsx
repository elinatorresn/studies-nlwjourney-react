...
export function DestinationAndDateStep({ isGuestsInputOpen, closeGuestsInput, openGuestsInput, setDestination, eventStartAndDates, setEventStartAndDates }: DestinationAndDateStepProps) {
  ...
  return(
    <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
      ...
      {isGuestsInputOpen ? (
        <Button onClick={closeGuestsInput} size="default" variant="gray">
          Alterar local/data
          <Settings2 className="size-5" />
        </Button>
      ): (
        <Button onClick={openGuestsInput} size="default" variant="green">
           Continuar
