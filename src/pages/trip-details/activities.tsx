        ...
        return(
          <div key={category.date} className="space-y-2.5">
            <div className="flex gap-2 items-baseline">
              <span className="text-xl text-zinc-300 font-semibold">{format(category.date, "d' de 'LLL")}</span>
                ...
                {category.activities.map(activity => {
                  return (
                    <div className="space-y-2.5">
                      <div key={activity.id} className="bg-zinc-900 px-4 py-2.5 rounded-xl shadow-shape flex items-center gap-3">
